...
/**
 * Invokes the given iterator for all enumerable properties passing key and value.
 */
exports.each = function(obj, it) {
  Object.keys(obj).forEach(function(key) { it.call(obj, key, obj[key]); });
};
