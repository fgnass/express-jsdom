...
ScriptAsset.prototype = {
  ...
  insert: function(document) {
    var localSrc = this.resource && Path.join(mapping, this.resource.version, this.name + '.js');
    if (this.cdn) {
      insertElement('script', {src: this.cdn}, document.head);
      if (this.test) {
        insertElement('script', {
          text: '!(' + utils.testExpr(this.test) + ')' +
...
exports.aspect = {
  ...
  apply: function(context, document) {
