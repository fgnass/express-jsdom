...
var baseDir = (function() {
  var p = module.parent;
  while (p && p.id != 'express-jsdom') {
    p = p.parent;
  }
  return Path.dirname((p || module).parent.filename);
}());
  ...
  if (aspect) {
    if (Array.isArray(aspect)) {
      ...
      if (typeof aspect == 'string') {
        aspect = exports.aspects[aspect] || utils.fail('No such built-in aspect: {}', aspect);
      }
...
/**
 * Sets the base directory. Defaults to the directory
 * of the module that required this module.
 */
exports.setBaseBir = function setBaseDir(dir) {
  baseDir = dir;
  return exports;
};
...
Server.prototype.serve = function(view, fn) {
  this.all(view, exports.serve.apply(this, arguments));
